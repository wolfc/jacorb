    ...
    extends BaseType
{
    ...
    public String getTypeCodeExpression()
    {
        return "org.omg.CORBA.ORB.init().create_value_tc(\"" + id() +
            "\",\"AbstractBase\", org.omg.CORBA.VM_NONE.value, org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_null), new org.omg.CORBA.ValueMember[]{} )";
    }
    ...
    {
        return "((org.omg.CORBA_2_3.portable.InputStream)" + streamname + ").read_Abstract()";
    }

    public String printWriteStatement( String var_name, String streamname )
    {
        return "((org.omg.CORBA_2_3.portable.OutputStream)" + streamname +
            ").write_Abstract(" + var_name + ");";
    }
}
